...
def assemble_feature_matrix(df, drop_lags_na=True):
    ...
    if n_rows >= 30:
        weekly_specs = {
            ...
            # "spec_K_all_channels": {
            #     "target": "log_total_gmv",
            #     "features": [f"log_{ch}" for ch in MEDIA_CHANNELS] + ["sale_flag"],
            #     "description": "All 9 individual channels + sale (10 features). Relies on Lasso/Ridge for channel-level ROI.",
            # },
        }
